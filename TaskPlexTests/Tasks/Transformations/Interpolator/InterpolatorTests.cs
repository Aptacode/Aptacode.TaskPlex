...
namespace Aptacode.TaskPlex.Tests.Tasks.Transformations.Interpolator
{
    ...
    public class InterpolatorTests
    {
        ...
        {
            var result = DoubleInterpolator.Interpolate(stepCount, Easers.Linear, startValue, endValue);
        ...
        {
            Assert.That(IntInterpolator.Interpolate(stepCount, Easers.Linear, startValue, endValue),
