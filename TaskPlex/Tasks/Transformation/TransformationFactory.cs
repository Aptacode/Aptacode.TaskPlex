...
namespace Aptacode.TaskPlex.Tasks.Transformation
{
    public static class TransformationFactory
    {
        ...
        public static StringTransformation<T> Create<T>(T target, string property, string endValue, TimeSpan duration, RefreshRate refreshRate = RefreshRate.Normal) where T : class
        {
